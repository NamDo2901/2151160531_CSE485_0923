<?php
    ...
    try {
        ...
        $sql = "SELECT * FROM sach ORDER BY id DESC LIMIT 10 OFFSET $n";
    ...
    <div class="row">
        ...
        <div class="col-md-9 main">
            ...
            <div class="main-content vh-100 p-3">
                <h3 class=" text-center text-uppercase">Danh sach Sach</h3>
                <a href="user_add.php" class="btn btn-success"><i class="bi bi-person-add"></i> Them sach</a>
                <?php
                     if(isset($_GET['success'])){
                         $id = $_GET['success'];
                         echo "<h2 style='color:red'>Sach co id: {$id} da bi xoa</h2>";
                     }
                ?>
                <table class="table">
                    <thead>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="exampleModalLabel">Xoa sach</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                Ban chac chan muon xoa sach co id: <?= $user['id']; ?>?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                <a href="user_delete.php?id=<?= $user['id']; ?>" class="btn btn-success">OK</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
