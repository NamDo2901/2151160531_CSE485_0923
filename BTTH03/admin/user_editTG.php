    ...
    <div class="row">
        ...
        <div class="col-md-9 main">
            ...
            <div class="main-content vh-100 p-3">
                ...
                ?>
                <h3 class=" text-center text-uppercase">Chinh sua thong tin tac gia</h3>
                <form action="process_user_editTG.php" method="post">
                    <div class="row input-group mb-3">
                        ...
                        <div class="col-md-8">
                            <button type="submit" class="btn btn-success" name="sbmSaveTG">Save</button>
                        </div>
                    </div>
                </form>
            </div>
